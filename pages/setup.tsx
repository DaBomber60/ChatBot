...
export default function SetupPage() {
  ...
  return (
    <>
      <Head>
        <title>Setup - HomeChatBot</title>
        <meta name="description" content="Initial setup for HomeChatBot" />
      </Head>
      ...
      <div className="min-h-screen flex items-center justify-center p-4 sm:p-6" style={{ minHeight: '100vh' }}>
        <div className="card w-full max-w-md mx-auto" style={{ minHeight: 'fit-content' }}>
          <div className="text-center mb-8">
            ...
            <p className="text-secondary">Set up your access password for HomeChatBot</p>
          </div>
          ...
          <div className="text-center mt-6">
            <p className="text-xs text-muted">
              This password will be required to access your HomeChatBot.
              <br />
