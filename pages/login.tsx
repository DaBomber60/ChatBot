...
export default function LoginPage() {
  ...
  return (
    <>
      <Head>
        <title>Login - HomeChatBot</title>
        <meta name="description" content="Access your HomeChatBot" />
      </Head>
      ...
      <div className="min-h-screen flex items-center justify-center p-4 sm:p-6" style={{ minHeight: '100vh' }}>
        <div className="card w-full max-w-md mx-auto" style={{ minHeight: 'fit-content' }}>
          <div className="text-center mb-8">
            <h1 className="text-2xl sm:text-3xl font-bold mb-2 text-primary">🤖 HomeChatBot</h1>
